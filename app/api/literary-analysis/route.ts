...
// CACHING DESIGN
//
// The stable block (system prompt + full book text below) is marked with
// cache_control so it is written to the cache on the first request and read
// cheaply on every subsequent one.
//
// Render order: tools → system → messages
// The cache_control on the last system text block covers everything before it.
//
// Minimum cacheable prefix for Opus 4.7: 4 096 tokens.
// The combined system prompt + Pride and Prejudice chapters below comfortably
// exceeds that threshold. A short system prompt (like the original Python
// snippet) would silently produce cache_creation_input_tokens: 0.
// ─────────────────────────────────────────────────────────────────────────────

const ANALYSIS_FRAMEWORK = `\
You are an expert literary analyst with deep knowledge of English literature,
narrative theory, and close-reading technique. Your task is to provide
insightful, evidence-based commentary on the text provided.

When answering questions about a literary work, you should:

1. THEMES — Identify the major and minor themes at work. Ground each claim in
   specific passages, character behaviour, or structural choices. Explain how
   themes develop across the work rather than simply naming them.

2. CHARACTERS — Analyse characters as constructs: examine their function in the
   plot, their symbolic weight, their relationships, and how they change (or
   refuse to change). Distinguish between what characters say, what they do, and
   what the narrator implies about them.

3. STYLE AND VOICE — Comment on sentence rhythm, diction, irony, free indirect
   discourse, and any other stylistic devices the author deploys. Explain the
   effect these choices have on the reader.

4. SOCIAL AND HISTORICAL CONTEXT — Where relevant, situate the text in its
   original moment: class structures, gender norms, economic realities, and
   literary conventions of the period.

5. STRUCTURE AND FORM — Consider chapter organisation, narrative point of view,
   temporal structure, and how form reinforces (or complicates) content.

Always quote directly from the text to support your arguments. Prefer precision
over generality. Avoid plot summary unless it directly supports an analytical
point.

─────────────────────────────────────────────────────────────────────────────
PRIMARY TEXT: Pride and Prejudice by Jane Austen (1813) — Chapters I–XI
...
Mr. Bennet was among the earliest of his neighbours in paying his respects to
Mr. Bingley. He had always intended to visit, though to the last always assuring
...
"Stop your coughing so, Kitty, for heaven's sake! Have a little compassion on
...
The astonishment of the ladies was just what it should be; and the eldest of
them, with the most natural expression of joy, was what she should be too. But
Jane was so diffident, and her daughters so eager, that Mr. Bennet was obliged
to return to the subject: "Now, Kitty, you may cough as much as you choose,"
said he; and, as he spoke, he left the room, fatigued with the raptures of his
wife.
...
"Oh!" said Lydia stoutly, "I am not afraid; for though I am the youngest, I am
the tallest."
...
of their neighbour Lady Lucas. Her report was highly favourable. Sir William had
...
instead of twelve, he had brought only six with him from London, his five sisters
...
and ductility of his temper, though no disposition could offer a greater contrast
to his own, and though with his own he never appeared dissatisfied. On the
strength of Darcy's regard Bingley had the firmest reliance, and of his judgment
the highest opinion. In understanding, Darcy was the superior. Bingley was by no
means deficient, but Darcy was clever. He was at the same time haughty, reserved,
and fastidious, and his manners, though well bred, were not inviting. In that
respect his friend had greatly the advantage. Bingley was sure of being liked
wherever he appeared, Darcy was continually giving offence.

The manner in which they spoke of the Meryton assembly was sufficiently
characteristic. Bingley had never met with pleasanter people or prettier girls in
his life; every body had been most kind and attentive to him, there had been no
formality, no stiffness, he had soon felt acquainted with all the room; and as to
Miss Bennet, he could not conceive an angel more beautiful. Darcy, on the contrary,
had seen a collection of people in whom there was little beauty and no fashion, for
...
Mrs. Hurst and her sister allowed it to be so but still admired her and liked
her, and pronounced her to be a sweet girl, and one whom they would not object to
know more of. Miss Bennet was therefore established as a sweet girl, and their
brother felt authorised by such commendation to think of her as he chose.
...
never see a fault in any body. All the world are good and agreeable in your eyes.
...
still better, and say nothing of the bad, belongs to you alone. And so, you like
...
and were therefore in every respect entitled to think well of themselves, and
meanly of others. They were of a respectable family in the north of England; a
...
residence in a small market town; and quitting them both, he had removed with his
family to a house about a mile from Meryton, denominated from that period Lucas
Lodge, where he could think with pleasure of his own importance, and unshackled
by business, occupy himself solely in being civil to all the world. For though
elated by his rank, it did not render him supercilious; on the contrary, he was
all attention to every body. By nature inoffensive, friendly and obliging, his
...
and which he thought the prettiest? and his answering immediately to the last
question — Oh! the eldest Miss Bennet beyond a doubt, there cannot be two
...
"My overhearings were more to the purpose than your's, Eliza," said Charlotte.
...
he is eat up with pride, and I dare say he had heard somehow that Mrs. Long does
...
man, with family, fortune, every thing in his favour, should think highly of
...
she considered with pleasure that it was not likely to be discovered by the world
in general, since Jane united with great strength of feeling, a composure of
temper and a uniform cheerfulness of manner, which would guard her from the
...
in almost every attachment, that it is not safe to leave any to itself. We can
all begin freely — a slight preference is natural enough; but there are very few
of us who have heart enough to be really in love without encouragement. In nine
cases out of ten, a woman had better shew more affection than she feels. Bingley
...
other in large mixed parties, it is impossible that every moment should be
...
there will be more leisure for falling in love as much as she choses."
...
her own regard, nor of its reasonableness. She has known him only a fortnight.
She danced four dances with him at Meryton; she saw him one morning at his own
house, and has since dined in company with him four times. This is not quite
...
marriage is entirely a matter of chance. If the dispositions of the parties are
...
eyes of his friend. Mr. Darcy had at first scarcely allowed her to be pretty; he
had looked at her without admiration at the assembly; and when they next met, he
looked at her only to criticise. But no sooner had he made it clear to himself
and his friends that she had hardly a good feature in her face, than he began to
find it was rendered uncommonly intelligent by the beautiful expression of her
dark eyes. To this discovery succeeded some others equally mortifying. Though he
...
her he was only the man who made himself agreeable no where, and who had not
...
and sing before any body and every body! — If my vanity had taken a musical turn,
you would have been invaluable; but as it is, I would really rather not sit down
before those who must be in the habit of hearing the very best performers." On
Miss Lucas's persevering, however, she added, "Very well; if it must be so, it
must." And gravely glancing at Mr. Darcy, "There is a fine old saying, which
every body here is of course familiar with — 'Keep your breath to cool your
...
consequence of being the only plain one in the family, worked hard for knowledge
...
Sir William only smiled. "Your friend performs delightfully," he continued after
a pause, on seeing Bingley join the group; — "and I doubt not that you are an
...
of doing a very gallant thing, and called out to her:
...
self-importance of all these people! — What would I give to hear your strictures
on them!"
...
in this manner, and as his composure convinced her that all was safe, her wit
flowed long.
`;

// Place cache_control on this block so it is written to cache on the first
// request and read on every subsequent one. The combined text above is well
// over 4096 tokens, satisfying the Opus 4.7 minimum.
const CACHED_SYSTEM_BLOCK: Anthropic.TextBlockParam = {
  type: "text",
...
export async function POST(request: Request) {
  try {
    ...
    const response = await client.messages.create({
      ...
      max_tokens: 1024,
      // system is an array of blocks so we can mark the large stable block for
      // caching independently of the (short, varying) per-request context.
      system: [CACHED_SYSTEM_BLOCK],
      messages: [
        {
          role: "user",
          // The question is the volatile part — it is NOT cached.
          content: question,
        },
      ],
    });
    ...
    return NextResponse.json({
      analysis: text,
      // Return raw usage so callers can verify caching is working.
      // cache_creation_input_tokens > 0 → cache was written this request
      // cache_read_input_tokens > 0     → cache was read (cheaper)
      // Both zero across repeated calls → prefix is too short or keeps changing
